...
ENV HOME /root
COPY --from=build_base /terraform-provider-kafka_v0.2.10 $HOME/.terraform.d/plugins/registry.terraform.io/mongey/terraform-provider-kafka_v0.2.10
COPY --from=build_base /terraform-provider-confluentcloud_v0.0.5 $HOME/.terraform.d/plugins/registry.terraform.io/mongey/terraform-provider-confluentcloud_v0.0.5
